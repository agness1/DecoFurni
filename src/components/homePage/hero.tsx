...
const HeroSection: FC = ({}) => {
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-screen relative p-4">
        <div className="flex flex-col justify-center items-center gap-8  ">
          ...
          <p className="pb-2 text-center md:w-80 md:text-left 2xl:w-1/2">
        ...
        <Image
          className="p-2 md:absolute right-20 top-20 lg:right-40 "
        ...
        />
        <Image
          className="p-2 md:absolute left-20 top-10 lg:left-40 "
        ...
        />
        <Image
          className="absolute bottom-0 left-10 hidden md:block lg:left-56 p-4"
        ...
        />
        <Image
          className="absolute bottom-10 right-20 hidden md:block lg:right-48"
